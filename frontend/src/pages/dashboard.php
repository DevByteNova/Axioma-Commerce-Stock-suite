...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 p-6">
            ...
            <div class="max-w-4xl mx-auto mb-8 flex flex-wrap gap-4">
                <a href="frontend/src/pages/clientes.php" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-200">
                    <span class="mr-2">👥</span> Gestionar Clientes
                </a>

                <a href="index.php?url=registro_vendedor" class="inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-200">
                    <span class="mr-2">🧑‍💼</span> Registrar Vendedor
                </a>
            </div>
